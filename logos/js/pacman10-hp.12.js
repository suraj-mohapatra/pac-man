...
*/
  ...
  ja(v, Qb);
  v.i = {};
  v.i.Za = new Zb("/logos/2010/", "pacman10_regular");
  v.i.Sa = new Zb("/logos/2010/", "pacman10_looped");
  var w = v.i;
  v.g = {};
  ...
  var Ve = function (a) {
    ...
    zf = function (a) {
      document.getElementById("hplogo-b").style.width =
        Math.round(200 * a) + "px";
    },
    kf = function (a) {
      a = "pacman,e:" + a;
      var b;
      (b = !!document.getElementById("fkbx")) ||
        ((b = wc.i.get("ntp")), (b = "1" == b || "2" == b));
      b && (a += "&ntp=1");
      -1 == a.search("&ei=") &&
        ((a += "&ei="),
        Ec ||
          (window.google && window.google.kEI && window.google.kEI.length
            ? (Ec = window.google.kEI)
            : document.querySelector("body#iframedoodle") &&
              vc(wc.i, "ei") &&
              (Ec = wc.i.get("ei"))),
        (b = Ec) && (a += b));
